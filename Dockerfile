...
COPY debug-hota.sh /usr/local/bin/debug-hota
COPY test-vcmi-mod-loading.sh /usr/local/bin/test-vcmi-mod-loading
COPY show-logs.sh /usr/local/bin/show-logs
RUN chmod +x /usr/local/bin/vcmiclient-autoload /usr/local/bin/vcmiclient-newgame /root/.vnc/xstartup /usr/local/bin/download-homm3-files /usr/local/bin/enable-hota-mod /usr/local/bin/restart-vcmi /usr/local/bin/check-vcmi-mods /usr/local/bin/run-diagnostics /usr/local/bin/debug-hota /usr/local/bin/test-vcmi-mod-loading /usr/local/bin/show-logs
